      ...
      <li class="game__wrapper">
        ...
        <div class="audio__game select-level">
          <div class="check-container">
            <input type="radio" name="select-audio" id="audio-level-1" value="1" checked>
            <label class="free-label four col" for="audio-level-1">Level 1</label>
          </div>
          <div>
            <input type="radio" name="select-audio" id="audio-level-2" value="2">
            <label class="basic-label four col" for="audio-level-2">Level 2</label>
          </div>
          <div>
            <input type="radio" name="select-audio" id="audio-level-3" value="3">
            <label class="premium-label four col" for="audio-level-3">Level 3</label>
          </div>
          <div>
            <input type="radio" name="select-audio" id="audio-level-4" value="4">
            <label class="free-label four col" for="audio-level-4">Level 4</label>
          </div>
          <div>
            <input type="radio" name="select-audio" id="audio-level-5" value="5">
            <label class="basic-label four col" for="audio-level-5">Level 5</label>
          </div>
          <div>
            <input type="radio" name="select-audio" id="audio-level-6" value="6">
            <label class="premium-label four col" for="audio-level-6">Level 6</label>
          </div>

        </div>
        <div class="start-container">
          <a class="button minigames__btn-start" href="#/audiogame">Start Game</a>
        </div>
      </li>
      <li class="game__wrapper">
        ...
        <div class="sprint__game select-level">
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-1" value="1" checked>
            <label class="free-label four col" for="sprint-level-1">Level 1</label>
          </div>
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-2" value="2">
            <label class="basic-label four col" for="sprint-level-2">Level 2</label>
          </div>
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-3" value="3">
            <label class="premium-label four col" for="sprint-level-3">Level 3</label>
          </div>
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-4" value="4">
            <label class="free-label four col" for="sprint-level-4">Level 4</label>
          </div>
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-5" value="5">
            <label class="basic-label four col" for="sprint-level-5">Level 5</label>
          </div>
          <div>
            <input type="radio" name="select-sprint" id="sprint-level-6" value="6">
            <label class="premium-label four col" for="sprint-level-6">Level 6</label>
          </div>
        </div>
        <div class="start-container">
          <a class="button minigames__btn-start" href="#/sprintgame">Start Game</a>
        </div>
      </li>
    </ul>
  </div>
